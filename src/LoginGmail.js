...
import LoginPhone from "./images/LoginPhone.jpg";
      ...
      <div className="container firebase-maincard  text-center" >
             ...
             <div className="row firebase-row  text-center">
                 ...
                 <h2 className="firebase-let fw-bolder">Let's Get Started</h2>
                   ...
                   <h4 className="mt-4 mb-4 text-center " style={{color:"#686868"}}>or join with us</h4>
                  <div className="firebase-btn text-center mb-4">
                  <NavLink className="nav-link" to="/Login">
                       <img src={ LoginPhone } id="gicon" alt="google-icon"/>
                       </NavLink>
                       <NavLink className="nav-link" to="/LoginEmail">
                  <img src={ emailicon }  alt="email-icon"/></NavLink>
                  </div>
